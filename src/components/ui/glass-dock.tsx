...
// Register MorphSVGPlugin if available (free since GSAP 3.13).
...
const MorphingIcon = ({
        ...
        gsap.to(path, {
          keyframes: [
            ...
            },
            {
              ...
              onStart: () => {
                gsap.to(button, {
                  "--tab-bar-linkedin-scale": 0.7,
                  duration: 0.8,
                  ease: "elastic.out(1, .9)",
                });
                gsap.to(button, {
                  "--tab-bar-linkedin-opacity": 1,
                  duration: 0.2,
                });
              },
            },
  ...
  // Resting (final) shapes per type.
  const restingPath: Record<MorphType, string> = {
    home: "M3 18V10.5339C3 9.57062 3.46259 8.66591 4.24353 8.1019L10.2435 3.76856C11.2921 3.01128 12.7079 3.01128 13.7565 3.76856L19.7565 8.1019C20.5374 8.66591 21 9.57062 21 10.5339V18C21 19.6569 19.6569 21 18 21H6C4.34315 21 3 19.6569 3 18Z",
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24">
        <path ref={pathRef} d={restingPath[type]} />
      </svg>
    </button>
  );
};
